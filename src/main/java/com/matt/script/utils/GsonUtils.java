...
public final class GsonUtils {
    ...
    public static void setGson(final String key, final Gson gson) {
        if (key == null || key.isEmpty() || gson == null) return;
        GSONS.put(key, gson);
    }
     ...
     * @return object serialized into json.
     */
    public static String toJson(final Object src, @NotNull final Type typeOfSrc) {
     ...
     * @return object serialized into json.
     */
    public static String toJson(@NotNull final Gson gson, final Object object) {
     ...
     * @return object serialized into json.
     */
    public static String toJson(@NotNull final Gson gson, final Object src, @NotNull final Type typeOfSrc) {
     ...
     */
    public static <T> T fromJson(final String json, @NotNull final Class<T> type) {
     ...
     * @return instance of type
     */
    public static <T> T fromJson(final String json, @NotNull final Type type) {
        return fromJson(getGson(), json, type);
    }
     ...
     * @return instance of type
     */
    public static <T> T fromJson(@NotNull final Reader reader, @NotNull final Class<T> type) {
     ...
     * @return instance of type
     */
    public static <T> T fromJson(@NotNull final Reader reader, @NotNull final Type type) {
        return fromJson(getGson(), reader, type);
    }
     ...
     * @return instance of type
     */
    public static <T> T fromJson(@NotNull final Gson gson, final String json, @NotNull final Class<T> type) {
     ...
     * @return instance of type
     */
    public static <T> T fromJson(@NotNull final Gson gson, final String json, @NotNull final Type type) {
        return gson.fromJson(json, type);
    }
     ...
     * @return instance of type
     */
    public static <T> T fromJson(@NotNull final Gson gson, final Reader reader, @NotNull final Class<T> type) {
     ...
     * @return instance of type
     */
    public static <T> T fromJson(@NotNull final Gson gson, final Reader reader, @NotNull final Type type) {
        return gson.fromJson(reader, type);
    }
     ...
     * @return the type of {@link List} with the {@code type}
     */
    public static Type getListType(@NotNull final Type type) {
     ...
     * @return the type of {@link Set} with the {@code type}
     */
    public static Type getSetType(@NotNull final Type type) {
     ...
     * @return the type of map with the {@code keyType} and {@code valueType}
     */
    public static Type getMapType(@NotNull final Type keyType, @NotNull final Type valueType) {
     ...
     */
    public static Type getArrayType(@NotNull final Type type) {
     ...
     * @return the type of map with the {@code type}
     */
    public static Type getType(@NotNull final Type rawType, @NotNull final Type... typeArguments) {
